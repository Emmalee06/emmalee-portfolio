...
export const ProjectCard = ({
  ...
  return (
    <div className={`group w-full max-w-6xl mx-auto mb-8 px-2`}>
      <div
        className={`flex flex-col ${layout === "right" ? "lg:flex-row-reverse" : "lg:flex-row"} items-stretch gap-8 w-full min-h-[180px] lg:min-h-[180px]`}
      >
