    ...
    >
      <div className="text-center space-y-8 max-w-4xl">
        ...
        <div className="flex flex-col sm:flex-row items-center justify-center gap-4 pt-8">
          <button className="group relative px-8 py-3 rounded-full border border-gray-800 text-gray-800 font-medium text-lg overflow-hidden transition-all duration-300 gradient-animated-btn">
