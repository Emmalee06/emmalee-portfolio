        ...
        <div className="mx-auto w-full max-w-6xl grid grid-cols-1 lg:grid-cols-12 gap-8">
          <div className="lg:col-span-7 rounded-3xl p-8">
            ...
            <p className="text-gray-800 leading-relaxed">
              ...
              inspiration from the constellations and cosmos. Discover your star
              sign through a unique taste of bubbles, fruits, and berries.
            </p>
          </div>
      ...
      <section className="px-4 pb-14">
        <div className="mx-auto w-full max-w-6xl grid grid-cols-1 lg:grid-cols-12 gap-8 items-stretch">
          ...
          <div className="lg:col-span-7 rounded-3xl p-8">
            ...
            <p className="text-gray-800 leading-relaxed">
              Many consumers struggle to find sodas that feel holistically
              inspired and emotionally engaging. Starlight Soda is designed with
        ...
        <div className="mx-auto w-full max-w-6xl">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-6">
            {[
              ...
              <div key={item.name} className="rounded-3xl overflow-hidden">
